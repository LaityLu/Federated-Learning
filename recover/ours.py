...
import aggregator
from recover import FedEraser
from utils import parameters_to_vector, setup_logger, model_to_traj
...
class Ours(FedEraser):
    def __init__(self,
        ...
        self.X_clients = kwargs.get('select_client_ratio', 0.9)
        self.alpha = kwargs.get('alpha', 0.1)
        self.train_loss = kwargs.get('train_loss', None)
        self.aggr_clients = kwargs.get('aggr_clients', None)
        self.window_size = 1
